...
const SettingsModal = ({ onClose }) => {
  ...
  return (
    ...
    >
      <div
        className={`bg-[#D5D5D5]/85 m-4 p-4 pb-8 rounded-lg shadow-xl gap-2 flex flex-col justify-center border-2 transform transition-all duration-200 ${
      ...
      >
        ...
        <>
          <div className="hidden md:flex text-xl h-full items-center flex-row gap-10 justify-between mx-6 mt-4">
