    ...
    >
      <div className="flex flex-col items-center w-full">
        ...
        <div className="backdrop-blur-md border-2 border-black/10 p-4 w-[80%] rounded-md flex flex-col items-center -translate-y-4 bg-white/30">
          ...
          <h1 className="text-3xl text-center font-bold">{t(`weatherCodes.${code}`)}</h1>
          ...
          <div
            className="flex flex-row  w-full rounded-2xl p-2 ring-1 my-6 ring-white/20 ring-offset-0"
